...
//  Player.cpp
//
//  Created by Mihika Marathe, Johnny Nguyen, and Felicia Dewanaga
//  Copyright © 2019 Mihika Marathe, Johnny Nguyen, and Felicia Dewanaga
//  All rights reserved.
 ...
 */
Player::Player(sf::Texture& inputTexture, sf::Texture& inputShieldTexture, sf::Texture& inputFlippedTexture, sf::Texture& inputFlippedShieldTexture, float h, float w)
	: Entity(inputTexture, w, h)
{
    lives = 5;
    score = 0;
    hit = -1;
...
void Player::loseLife()
{
    ...
    {
        cout << "Shielded against a monster!" << endl;
        loseShield();
    }
}
...
/*
 Description: This function tracks the collision of the player and coins. It checks the distance and if a collision is found, it increments the score. It returns true or false based on whether or not a collision occured.
 Parameters: coordinates of the coin, size of the coin
...
/*
 Description: This function overloads the insertion operator and prints the score and lives. 
